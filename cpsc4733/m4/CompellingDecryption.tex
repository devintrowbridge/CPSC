...
\begin{abstract}
  In this paper, I argue that forcing individuals or organizations to decypt their data is unethical. My arguments are rooted in deontological ethical theory based primarily on precedent set in US constitutional law and US court cases. I occasionally venture out into precedent set in other parts of history and the world.
\end{abstract}
