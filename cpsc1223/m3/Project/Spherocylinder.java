 ...
 */
  ...
  /**
    * Comparison function for comparing two spherocylinders.
    *
    * @param obj spherocylinder object to compare against
    * @return -1 for less than, 1 for greater than, 0 for equal
    */ 
